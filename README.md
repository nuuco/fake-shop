...
- 다르게 설계한 UI·기능: 브랜드명 **Tomato Market**, 미니멀 UI(흰 배경·큰 Inter 타이포·무카드 그리드·글라스 헤더), Google·이메일 로그인, 검색·필터·상세·LocalStorage·담기 미리보기·계산하기
...
추가 구현: 상품 상세(`/product/:id`) — 담기 상태 문구·장바구니 이동, 헤더 담기 미리보기, 계산하기(합계 토스트 후 cart 비우기)
